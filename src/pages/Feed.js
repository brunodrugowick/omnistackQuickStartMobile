...
export default class Feed extends Component {
  static navigationOptions = ({ navigation }) => ({
      headerRight: (
          <TouchableOpacity style={{ marginHorizontal: 25 }} onPress={() => navigation.navigate('New')}>
              <Image source={camera} />
          </TouchableOpacity>
      ),
  });
  ...
  registerToSocket = () => {
    const socket = io('https://omnistack-quick-start-backend.herokuapp.com');
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <View style={styles.feedItem}>
            ...
            <Image style={styles.feedImage} source={{uri: item.s3Url }}/>
